        ...
        $.ajax({
            ...
            success : function(feedback){
                if(feedback == "error"){
                    ...
                    $(".files-error").html("<span class='files-cross-icon'>&#x2715;</span>"+ "Error unsupported file upload");
                    setTimeout(function(){
...
//call show_messages function after every 3seconds
online_users();
...
// Logout user when time is over 30 minutes
